CREATE OR REPLACE TABLE `cyclistic-analysis-479022`.cyclistic_case_study.clean_2019_Q4 AS -- Create a clean table
SELECT
...
FROM
  (
    ...
    FROM
      `cyclistic-analysis-479022`.cyclistic_case_study.raw_2019_Q4
  )
WHERE
